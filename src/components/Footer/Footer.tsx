...
const EMAIL_SUBJECT =
  "Contato via Portfólio - Dúvidas - Projetos - Melhorias - Sugestões";
...
export default function Footer() {
  ...
  const socials = [
    ...
    {
      label: "Instagram",
      href: "https://www.instagram.com/jhonherikgc/",
      icon: <FaInstagram />,
    },
    {
      label: "Discord",
      href: "https://discord.com/users/1170099561260404848",
      icon: <FaDiscord />,
    },
  ];
